...
* [x] User can navigate to **view their own profile**
  * [x] User can see picture, tagline, # of followers, # of favorite, and tweets on their profile.
* [x] User can **click on the profile image** in any tweet to see **another user's** profile.
 * [x] User can see picture, tagline, # of followers, # of favorite, and tweets of clicked user.
 ...
 * [x] User can take favorite retweet actions on a tweet
