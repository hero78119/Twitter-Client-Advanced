...
public class TwitterDao extends AbstractDao<Twitter, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property TwitterUserIdMapping = new Property(7, Long.class, "twitterUserIdMapping", false, "TWITTER_USER_ID_MAPPING");
        public final static Property In_reply_to_user_id = new Property(8, Long.class, "in_reply_to_user_id", false, "IN_REPLY_TO_USER_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TWITTER' (" + //
                ...
                "'TYPE' TEXT," + // 5: type
                "'TEXT' TEXT," + // 6: text
                "'TWITTER_USER_ID_MAPPING' INTEGER," + // 7: twitterUserIdMapping
                "'IN_REPLY_TO_USER_ID' INTEGER);"); // 8: in_reply_to_user_id
    }
    ...
    public Twitter readEntity(Cursor cursor, int offset) {
        Twitter entity = new Twitter( //
            ...
            cursor.isNull(offset + 7) ? null : cursor.getLong(offset + 7), // twitterUserIdMapping
            cursor.isNull(offset + 8) ? null : cursor.getLong(offset + 8) // in_reply_to_user_id
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Twitter entity, int offset) {
        ...
        entity.setTwitterUserIdMapping(cursor.isNull(offset + 7) ? null : cursor.getLong(offset + 7));
        entity.setIn_reply_to_user_id(cursor.isNull(offset + 8) ? null : cursor.getLong(offset + 8));
     }
